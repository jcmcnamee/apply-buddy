...
namespace ApplyBuddy.Server.Migrations
{
    ...
    [Migration("20250514193439_RemoveChannelFromApplication")]
    partial class RemoveChannelFromApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.JobApplication.ApplicationChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.Listings.Listing", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Position", "ApplyBuddy.Server.Model.Listings.Listing.Position#Position", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("Salary", "ApplyBuddy.Server.Model.Listings.Listing.Position#Position.Salary#Salary", b2 =>
                                {
                                    b2.IsRequired();
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.JobApplication.JobApplication", b =>
                {
                    ...
                    b.HasOne("ApplyBuddy.Server.Model.Listings.Listing", "Listing")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.Listings.Listing", b =>
                {
                    b.HasOne("ApplyBuddy.Server.Model.JobApplication.ApplicationChannel", "DiscoverySource")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.JobApplication.SubmittedDetails", b =>
                {
                    b.HasOne("ApplyBuddy.Server.Model.JobApplication.ApplicationChannel", "Channel")
                        .WithMany()
