...
namespace ApplyBuddy.Server.Migrations
{
    ...
    [Migration("20250514191650_SubmittedDetailsFix")]
    partial class SubmittedDetailsFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.JobApplication.SubmittedDetails", b =>
                {
                    ...
                    b.HasIndex("ApplicationChannelId");
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.Listing.Listing", b =>
                {
                    b.HasOne("ApplyBuddy.Server.Model.ValueObjects.ApplicationChannel", "DiscoverySource")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplyBuddy.Server.Model.JobApplication.SubmittedDetails", b =>
                {
                    b.HasOne("ApplyBuddy.Server.Model.ValueObjects.ApplicationChannel", "Channel")
                        .WithMany()
                        .HasForeignKey("ApplicationChannelId");
